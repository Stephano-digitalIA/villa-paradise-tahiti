...
export function FaqHero() {
  // No section spacing of its own: the search field follows immediately, and
  // stacked default paddings pushed it most of a screen away from the intro it
  // belongs to. Only a small bottom gap remains; the Container keeps its top
  // padding for the fixed header.
  return (
    <Section tone="pearl" spacing="none" className="pb-4 sm:pb-6">
