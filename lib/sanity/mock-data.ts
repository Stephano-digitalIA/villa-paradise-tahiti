...
export const mockVilla: Villa = {
  ...
  description: [
    ...
    'Inside, four air-conditioned light-filled bedrooms are arranged around a vast open living space, dressed in fine, noble and exotic light wood. Wide glass doors blur the boundary between inside and outside, letting in natural light, cool mountain breezes and an unobstructed view of the ocean.',
