...
export const mockVilla: Villa = {
  ...
  description: [
    'Perched on a mountainside, nearly 500 metres above Tahiti, Villa Paradise Tahiti overlooks the vastness of the Pacific Ocean in an atmosphere of rare calm and serenity. Here, the air is fresh and pure, carried by trade winds and the scents of tropical vegetation. From the first light of day, the glow of the ocean envelops the villa in an almost dreamlike softness.',
    'The infinity pool seems to blend harmoniously into the turquoise lagoon and the infinite Pacific horizon, creating the illusion that the villa\'s waters and the ocean are one. From the terrace, the gaze drifts effortlessly between the deep blue sky, the lush mountain landscapes of Tahiti, and the ever-changing reflections of the sea.',
    'Inside, four air-conditioned light-filled bedrooms are arranged around a vast open living space, dressed in fine, noble and exotic light wood, woven rattan and natural linen. Wide glass doors blur the boundary between inside and outside, letting in natural light, cool mountain breezes and an unobstructed view of the ocean.',
    'The beaches and coastline are just a few minutes\' drive from the villa. This unique location offers a perfect balance between privacy, the freshness of the mountain climate and direct access to the sea.',
    'Beyond the villa, our concierge organizes bespoke experiences that will transform your stay into an unforgettable memory: a sunset cruise beyond the reef, a private chef preparing raw fish on the terrace, or a guided dive into the heart of coral gardens. We handle every detail so you can simply enjoy the moment. Dietary accommodations available for intolerances.',
  ].join('\n\n'),
  heroVideoUrl: 'https://videodelivery.net/7f3fc99987422d1ba3d25d0a4a22faa2/manifest/video.m3u8',
  heroImage: img(
