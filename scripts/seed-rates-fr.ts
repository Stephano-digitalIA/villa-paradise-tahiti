...
const FRENCH: ReadonlyArray<readonly [string, string]> = [
  ...
  ["rates.grid.intro", "Les tarifs s'entendent pour la villa entière (jusqu'à {maxGuests} personnes). Séjour minimum de {minNights} nuits."],
  ["rates.grid.unit", "par nuit"],
  ["rates.grid.low.name", "Basse saison"],
  ["rates.grid.low.window", "5 – 31 janvier · février · mars · octobre · novembre · 1er – 15 décembre"],
  ...
  ["rates.grid.high.window", "avril · mai · juin · septembre"],
  ...
  ["rates.grid.peak.window", "juillet · août · 16 – 31 décembre · 1er – 4 janvier"],
  ...
  ["rates.grid.footnote", "Les séjours de {longStayNights} nuits et plus bénéficient de {longStayPercent} % de remise longue durée. Précisez-le lors de votre demande."],
  ...
  ["rates.policy.value_minstay", "nuits"],
