...
const FRENCH: ReadonlyArray<readonly [string, string]> = [
  ...
  ["rates.grid.low.window", "5 janvier – 31 mars · 1er octobre – 15 décembre"],
  ...
  ["rates.grid.high.window", "Avril – juin · Septembre"],
  ...
  ["rates.grid.peak.window", "Juillet – août · 16 décembre – 4 janvier"],
